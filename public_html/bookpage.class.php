		...
		public function handleInput() {
			...
			if (isset($_POST['confirm'])
                ...
                if( !User::completeInformation() )  {
                    ...
                    //At least one field was left out, redirect back to previous page with a message somehow.
				...
				if (isset($_POST['booked_items_index'])) {
					...
					if ($numAvailable) {
						...
						if (($settingFrom = Setting::getSetting("email_from_address"))
							...
							$toAddress = User::getUser()."@student.liu.se"; //"viktorviktor@gmail.com"
							$site_url = $settingUrl['value'];
							$mailContent = $message."\n\n\n\n".$messageBookingItemEmailMessage;
							//old subject, couldn't print swedish char in subject. This way you do the job
							//$subject = mb_encode_mimeheader(Language::text("site_title").": ".Language::text("book_thank_you"), "UTF-8", "B", "\n");
						...
						// Inga valda föremål kunde bokas (hann bli fullbokat)
